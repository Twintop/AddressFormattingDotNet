...
namespace AddressFormattingDotNet.Models
{
    public class AddressParts
    {
        ...
        [YamlMember(Alias = "suburb", ApplyNamingConventions = false)]
        ...
        [YamlMember(Alias = "county_code", ApplyNamingConventions = false)]
        ...
        [YamlMember(Alias = "state_code", ApplyNamingConventions = false)]
        ...
        [YamlMember(Alias = "town", ApplyNamingConventions = false)]
        public string Town { get; set; }

        [YamlMember(Alias = "city_district", ApplyNamingConventions = false)]
